/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6bd78ce51d371ce0f3af7a90874013da)
// Runtime types generated with workerd@1.20250709.0 2025-06-28 
declare namespace Cloudflare {
	interface Env {
		SERVICE_TOKEN_ID: "";
		SERVICE_TOKEN_SECRET: "";
		RUMORS_API_URL: "https://api.cofacts.tw/graphql";
		LANGFUSE_PUBLIC_KEY: string;
		LANGFUSE_SECRET_KEY: string;
		LANGFUSE_HOST: string;
		OPENAI_API_KEY: string;
		URL_RESOLVER: Workflow;
		ARTICLE_CLASSIFIER: Workflow;
	}
}
